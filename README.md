...
- ניקוי מילות מילוי בעברית (אה, אממ, כאילו, יעני…) עם רשימה שניתן לערוך (עם הסבר ⓘ)
- רשימת מונחים ושמות, כדי שהמודל יזהה נכון שמות פרטיים ומושגים מקצועיים (עם הסבר ⓘ)
...
| מונחים ושמות | ברירת מחדל | רשימה שניתן לערוך · ⓘ להסבר |
| מילות מילוי | ברירת מחדל | רשימה שניתן לערוך · ⓘ להסבר |
...
במצב **מקצועי**, ליד כל אחת מהרשימות מופיע אייקון **ⓘ**. העברת העכבר עליו
מציגה הסבר קצר על השדה.
