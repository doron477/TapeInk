...
- חותמות זמן לכל קטע, עם מתג להצגה או להסתרה
- ניקוי מילות מילוי בעברית (אה, אממ, כאילו, יעני…) עם רשימה שניתן לערוך
- רשימת מונחים ושמות, כדי שהמודל יזהה נכון שמות פרטיים ומושגים מקצועיים
...
| מונחים ושמות | ברירת מחדל | רשימה שניתן לערוך |
| חותמות זמן | מתג בסרגל התמלול | מתג בסרגל התמלול |
...
לצדו יש מתג **חותמות זמן** שמכבה ומדליק את הזמנים בתצוגה, מיד וללא תמלול מחדש.

כל קטע נפתח בשורת כותרת שבה חותמת הזמן ואחריה שם הדובר, ורק אז הטקסט עצמו.
הזמן יושב בשורה נפרדת כדי שלא ייגרר לסוף הפסקה כשקטע ארוך נשבר לכמה שורות.
...
| שם או מונח מתומלל שגוי | הוסיפו אותו לרשימת **מונחים ושמות** במצב מקצועי |
